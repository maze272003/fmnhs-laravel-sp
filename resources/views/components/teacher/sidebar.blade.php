...
<nav id="sidebar" class="fixed top-0 left-0 h-full bg-white dark:bg-slate-900 shadow-xl w-64 p-4 flex flex-col transition-all duration-300 z-50 transform -translate-x-full md:translate-x-0 md:w-20 lg:w-64 border-r border-gray-200 dark:border-slate-800">
    ...
    <div class="flex items-center justify-between border-b border-gray-200 dark:border-slate-700 pb-4 mb-4">
        <div class="flex items-center gap-3 px-2">
            <div class="w-8 h-8 rounded bg-emerald-600 flex items-center justify-center text-white font-bold text-xl">T</div>
            <span class="nav-text font-bold text-xl text-slate-800 dark:text-white lg:block md:hidden">Faculty</span>
        </div>
    ...
    <ul class="flex flex-col flex-1 space-y-1 overflow-y-auto">
        ...
        <li>
            <a href="{{ route('teacher.dashboard') }}" class="nav-link flex items-center px-3 py-3 rounded-lg group transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-900/20">
                <i class="fa-solid fa-house nav-icon w-6 text-center text-gray-500 dark:text-gray-400 group-hover:text-emerald-600 transition-colors"></i>
                <span class="nav-text ml-3 font-medium text-gray-700 dark:text-gray-300 md:hidden lg:block">Overview</span>
            </a>
        </li>
        <li>
            <a href="{{ route('teacher.assignments.index') }}" class="nav-link flex items-center px-3 py-3 rounded-lg group transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-900/20">
                <i class="fa-solid fa-house nav-icon w-6 text-center text-gray-500 dark:text-gray-400 group-hover:text-emerald-600 transition-colors"></i>
                <span class="nav-text ml-3 font-medium text-gray-700 dark:text-gray-300 md:hidden lg:block">Task</span>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('teacher.attendance.index') }}" class="nav-link flex items-center px-3 py-3 rounded-lg group transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-900/20">
                <i class="fa-solid fa-chalkboard-user nav-icon w-6 text-center text-gray-500 dark:text-gray-400 group-hover:text-emerald-600 transition-colors"></i>
                <span class="nav-text ml-3 font-medium text-gray-700 dark:text-gray-300 md:hidden lg:block">Attendance</span>
            </a>
        </li>

        <li>
            <a href="{{ route('teacher.grading.index') }}" class="nav-link flex items-center px-3 py-3 rounded-lg group transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-900/20">
                <i class="fa-solid fa-pen-to-square nav-icon w-6 text-center text-gray-500 dark:text-gray-400 group-hover:text-emerald-600 transition-colors"></i>
                <span class="nav-text ml-3 font-medium text-gray-700 dark:text-gray-300 md:hidden lg:block">Grading Sheet</span>
            </a>
        </li>

        <li>
            <a href="{{ route('teacher.students.index') }}" class="nav-link flex items-center px-3 py-3 rounded-lg group transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-900/20">
