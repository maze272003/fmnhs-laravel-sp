...
<nav id="sidebar" class="fixed top-0 left-0 h-full bg-white dark:bg-slate-900 shadow-xl w-64 p-4 flex flex-col transition-all duration-300 z-50 transform -translate-x-full md:translate-x-0 md:w-20 lg:w-64 border-r border-gray-200 dark:border-slate-800">
    ...
    <ul class="flex flex-col flex-1 space-y-1 overflow-y-auto">
        ...
        <li>
            <a href="{{ route('student.assignments.index') }}" class="nav-link flex items-center px-3 py-3 rounded-lg group transition-colors hover:bg-blue-50 dark:hover:bg-blue-900/20">
                <i class="fa-solid fa-house nav-icon w-6 text-center text-gray-500 dark:text-gray-400 group-hover:text-blue-600 transition-colors"></i>
                <span class="nav-text ml-3 font-medium text-gray-700 dark:text-gray-300 md:hidden lg:block">My Task</span>
            </a>
        </li>
        <li>
            <a href="{{ route('student.attendance.index') }}" class="nav-link flex items-center px-3 py-3 rounded-lg group transition-colors hover:bg-blue-50 dark:hover:bg-blue-900/20">
                <i class="fa-solid fa-house nav-icon w-6 text-center text-gray-500 dark:text-gray-400 group-hover:text-blue-600 transition-colors"></i>
                <span class="nav-text ml-3 font-medium text-gray-700 dark:text-gray-300 md:hidden lg:block">Attendance</span>
            </a>
        </li>
        <li>
            <a href="{{ route('student.grades') }}" class="nav-link flex items-center px-3 py-3 rounded-lg group transition-colors hover:bg-blue-50 dark:hover:bg-blue-900/20">
        ...
        <li>
            <a href="{{ route('student.profile') }}" class="nav-link flex items-center px-3 py-3 rounded-lg group transition-colors hover:bg-blue-50 dark:hover:bg-blue-900/20">
