        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <a href="{{ route('parent.messages') }}" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition">
                        <div class="flex-shrink-0">
                    ...
                    <a href="{{ route('parent.children') }}" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
                        <div class="flex-shrink-0">
                    ...
                    <a href="{{ route('parent.dashboard') }}" class="flex items-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition">
                        <div class="flex-shrink-0">
